...
This is the source of the official [Chrome Multi-DeThe Chrome Multi-Device documentation
============
...
vice documentation]The Chrome Multi-Device documentation
============
...
Except as otherwise noted, the content of the DevTools documentation is licensed under the [Creative Commons Attribution 3.0 License](http://creativecommons.org/licenses/by/3.0/), and code samples are licensed under the [Apache 2.0 License](http://www.apache.org/licenses/LICENSE-2.0).
vice documentation](https://developer.chrome.com/multidevice/index) on developer.chrome.com (aka "DCC").
...
Except as otherwise noted, the content of the DevTools documentation is licensed under the [Creative Commons Attribution 3.0 License](http://creativecommons.org/licenses/by/3.0/), and code samples are licensed under the [Apache 2.0 License](http://www.apache.org/licenses/LICENSE-2.0).
(https://developer.chrome.com/multidevice/index) on developer.chrome.com (aka "DCC").
